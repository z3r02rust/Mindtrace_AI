...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!_editing) {
      ...
      _age.text = state.profile['age'] ?? '';
      _notes.text = state.profile['notes'] ?? '';
            ...
            children: [
              ...
              if (_editing) ...[
                ...
                _InfoRow(
                  ...
                  value: state.profile['health'] ?? '—',
                ),
                const Divider(height: 24, color: AppColors.border),
                _InfoRow(
                  icon: Icons.notes_rounded,
                  label: 'Tibbiy izoh',
                  value: state.profile['notes'] ?? 'Yo\'q',
                ),
              ],
            ],
          ),
