...
class PeopleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sorted = [...state.people]
      ..sort((a, b) => a.memoryStrength.compareTo(b.memoryStrength));
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Xotira mashqlarida ishlatiladigan shaxslar',
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          ProgressBarRow(
                            label: 'Xotira kuchi',
                            value: p.memoryStrength,
                            color: memoryStrengthColor(p.memoryStrength),
                          ),
                    ...
                    PopupMenuButton<String>(
                      ...
                      onSelected: (v) {
                        if (v == 'edit') {
                          _showPersonForm(context, person: p);
                        }
                        if (v == 'delete') {
                          context.read<AppState>().deletePerson(p.id);
                        }
                      },
                      itemBuilder: (_) => const [
  ...
  void _showAiTip(BuildContext context, Person person) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: FutureBuilder<AiResult>(
          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(tip, style: const TextStyle(fontSize: 14, height: 1.4)),
                if (result?.error != null) ...[
                  const SizedBox(height: 10),
                  Text(
                    'AI ulanmagan: ${result!.error}',
                    style: const TextStyle(
                      fontSize: 11,
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              person == null ? 'Yangi kishi qo\'shish' : 'Tahrirlash',
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Qarindoshlik/aloqa (Ona, Do\'st...)',
              ),
            ),
            const SizedBox(height: 12),
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Qo\'shimcha izoh (manzil, sana...)',
              ),
              maxLines: 2,
            ),
            const SizedBox(height: 20),
